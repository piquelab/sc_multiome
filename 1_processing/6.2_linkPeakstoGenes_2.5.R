...
##write_rds(df, paste0("./6.2_linkPeakstoGenes_2.5.outs/df_ind_platelet.rds")
write_rds(df, paste0("./6.2_linkPeakstoGenes_2.5.outs/df_ind_", MCls[1], ".rds"))
...
## #list <- read.table("./comb_list_Bcell.txt") %>% as.data.frame()
## list <- read.table(paste0("./", condition)) %>% as.data.frame()
## ##%>% mutate(V1=gsub(".", "-", V1)
## head(list)
...
## ##write_rds(df, paste0("./6.2_linkPeakstoGenes_2.5.outs/df_treats_NKcell.rds")
## write_rds(df, paste0("./6.2_linkPeakstoGenes_2.5.outs/df_treats_", MCls[1], ".rds"))
