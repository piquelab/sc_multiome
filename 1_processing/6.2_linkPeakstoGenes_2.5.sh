...
mkdir -p 6.2_linkPeakstoGenes_2.5_slurm
...
echo ${sample}
sbatch -q primary  -N1-1 -n 2 --mem=240G -t 2000 --job-name=${sample} -o "6.2_linkPeakstoGenes_2.5_slurm/slurm_${sample}" --wrap "Rscript 6.2_linkPeakstoGenes_2.5.R $sample"
sleep 0.5
done
